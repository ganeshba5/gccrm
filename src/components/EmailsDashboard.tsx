          ...
          <>
            ...
            <div className="divide-y divide-gray-200 dark:divide-gray-700">
              {emails.map((email) => (
                <div 
                  key={email.id} 
                  className="grid grid-cols-12 gap-4 px-6 py-3 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors items-center"
                >
                  ...
                  <div className="col-span-2">
                    <span className="text-sm text-gray-700 dark:text-gray-300 text-left truncate block">
                      {getSnippet(email)}
                    </span>
                  </div>
                  <div className="col-span-2">
