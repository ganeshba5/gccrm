 ...
 */
async function getEmailParseSettings() {
    ...
    return {
        subjectTokens: Array.isArray(parseSettings === null || parseSettings === void 0 ? void 0 : parseSettings.subjectTokens) ? parseSettings.subjectTokens : [],
        domains: Array.isArray(parseSettings === null || parseSettings === void 0 ? void 0 : parseSettings.domains) ? parseSettings.domains : [],
        emailAddresses: Array.isArray(parseSettings === null || parseSettings === void 0 ? void 0 : parseSettings.emailAddresses) ? parseSettings.emailAddresses : [],
    };
}
/**
 ...
 */
function extractForwardedEmailInfo(content) {
    var _a;
    if (!content) {
    ...
    if (result.from || result.to) {
        functions.logger.info(`   ✅ Successfully extracted forwarded email info:`, {
            from: result.from,
            to: result.to,
            originalContentLength: ((_a = result.originalContent) === null || _a === void 0 ? void 0 : _a.length) || 0,
        });
        return result;
    }
...
async function processEmail(emailDoc, createdBy) {
    ...
    try {
        ...
        let processedEmail = Object.assign({}, email);
        let originalEmailContent = null;
        let originalSubject = null;
        let forwardingWrapperContent = null; // Content before the forwarded section
        ...
        const fromEmail = ((_c = processedEmail.from) === null || _c === void 0 ? void 0 : _c.email) || '';
        const fromDomain = (_d = fromEmail.split('@')[1]) === null || _d === void 0 ? void 0 : _d.toLowerCase();
        const isInternalEmail = (fromDomain && parseSettings.domains.includes(fromDomain)) ||
        ...
        if (originalEmailContent) {
            ...
            const htmlContent = ((_e = processedEmail.body) === null || _e === void 0 ? void 0 : _e.html) || '';
        ...
        const filteredEmails = extractedData.contacts.emails.filter(email => {
            ...
            const emailDomain = (_a = emailLower.split('@')[1]) === null || _a === void 0 ? void 0 : _a.toLowerCase();
        ...
        if (routing === null || routing === void 0 ? void 0 : routing.accountName) {
            ...
            if (routing.opportunityName) {
                ...
                const opportunityName = `Email Opportunity - ${(cleanedSubject === null || cleanedSubject === void 0 ? void 0 : cleanedSubject.substring(0, 50)) || 'New'}`;
