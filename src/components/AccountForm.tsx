  ...
  const handleEditNote = (note: Note) => {
    ...
    if (id) {
      navigate(`/notes/${note.id}/edit`, { 
        state: { returnPath: `/accounts/${id}/edit` } 
      });
    } else {
      navigate(`/notes/${note.id}/edit`);
    }
                  ...
                  <div className="bg-gray-50 dark:bg-gray-700/30 rounded-lg overflow-hidden border border-gray-200 dark:border-gray-600 max-h-64 overflow-y-auto">
                    ...
                    <div className="divide-y divide-gray-200 dark:divide-gray-600">
                      {contacts.map((contact) => (
                        <div key={contact.id} className="px-3 py-2 hover:bg-gray-100 dark:hover:bg-gray-700/50 transition-colors">
                            ...
                            <div className="col-span-3">
                              ...
                              {contact.linkedin && (
                                <a 
                                  ...
                                  className="flex items-center gap-1 mt-1 text-xs text-brand-500 hover:text-brand-600 dark:text-brand-400 dark:hover:text-brand-300 underline"
                                >
